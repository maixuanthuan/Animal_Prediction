...
def train(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for iter, (images, labels) in enumerate(progress_bar):
            ...
            #Loss is scalar tensor (rank 0) is number

            progress_bar.set_description("Epoch {}/{}. Loss value: {:0.4f}".format(epoch+1, args.epochs, loss_value))
        ...
        writer.add_scalar("Val/Accur", acc, epoch )
